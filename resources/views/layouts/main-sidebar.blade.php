        ...
        <div class="side-menu-fixed">
            <div class="scrollbar side-menu-bg" style="overflow: scroll">
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <!-- Parents-->
                    <li>
                        <a href="{{route('pages.parents')}}" data-toggle="collapse" data-target="#Parents-menu">
                        ...
                        <ul id="Parents-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('pages.parents')}}">{{trans('main_trans.List_Parents')}}</a> </li>
                            <li> <a href="{{route('pages.parents.add_parent')}}">{{trans('main_trans.Add_Parent')}}</a> </li>
                        </ul>
                    </li>
